...
export default function Card({name,photo,country}){
  return(
        <div style={{ backgroundImage: `url(${photo})`, backgroundSize: 'cover',borderRadius:'10px'}} className=' mx-2 basis-1/2 drop-shadow-lg md:basis-1/3 lg:basis-0 inline-block'> 
