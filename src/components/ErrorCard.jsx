  ...
  return(
        <div className=' mx-2 basis-1/2 drop-shadow-lg md:basis-1/3 lg:basis-0'> 
            <div className='bg-theme rounded-lg flex place-content-between flex-col w-60 h-40'>
              <section className='text-inverse-theme bg-contain bg-[url(./public/assets/x-error.png)] bg-no-repeat bg-center p-2 ps-3 flex-col flex place-items-center place-content-center h-full'>
